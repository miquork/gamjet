...
// Wed Jun  9 16:18:42 2021 by ROOT version 6.18/04
// from TTree Events/Events
// found on file: files/mc-ht-200to400.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nElectron;
   Float_t         Electron_deltaEtaSC[nElectronMax];   //[nElectron]
   Float_t         Electron_dr03EcalRecHitSumEt[nElectronMax];   //[nElectron]
   Float_t         Electron_dr03HcalDepth1TowerSumEt[nElectronMax];   //[nElectron]
   Float_t         Electron_dr03TkSumPt[nElectronMax];   //[nElectron]
   Float_t         Electron_dr03TkSumPtHEEP[nElectronMax];   //[nElectron]
   Float_t         Electron_dxy[nElectronMax];   //[nElectron]
   Float_t         Electron_dxyErr[nElectronMax];   //[nElectron]
   Float_t         Electron_dz[nElectronMax];   //[nElectron]
   Float_t         Electron_dzErr[nElectronMax];   //[nElectron]
   Float_t         Electron_eCorr[nElectronMax];   //[nElectron]
   Float_t         Electron_eInvMinusPInv[nElectronMax];   //[nElectron]
   Float_t         Electron_energyErr[nElectronMax];   //[nElectron]
   Float_t         Electron_eta[nElectronMax];   //[nElectron]
   Float_t         Electron_hoe[nElectronMax];   //[nElectron]
   Float_t         Electron_ip3d[nElectronMax];   //[nElectron]
   Float_t         Electron_jetPtRelv2[nElectronMax];   //[nElectron]
   Float_t         Electron_jetRelIso[nElectronMax];   //[nElectron]
   Float_t         Electron_mass[nElectronMax];   //[nElectron]
   Float_t         Electron_miniPFRelIso_all[nElectronMax];   //[nElectron]
   Float_t         Electron_miniPFRelIso_chg[nElectronMax];   //[nElectron]
   Float_t         Electron_mvaFall17V1Iso[nElectronMax];   //[nElectron]
   Float_t         Electron_mvaFall17V1noIso[nElectronMax];   //[nElectron]
   Float_t         Electron_mvaFall17V2Iso[nElectronMax];   //[nElectron]
   Float_t         Electron_mvaFall17V2noIso[nElectronMax];   //[nElectron]
   Float_t         Electron_pfRelIso03_all[nElectronMax];   //[nElectron]
   Float_t         Electron_pfRelIso03_chg[nElectronMax];   //[nElectron]
   Float_t         Electron_phi[nElectronMax];   //[nElectron]
   Float_t         Electron_pt[nElectronMax];   //[nElectron]
   Float_t         Electron_r9[nElectronMax];   //[nElectron]
   Float_t         Electron_scEtOverPt[nElectronMax];   //[nElectron]
   Float_t         Electron_sieie[nElectronMax];   //[nElectron]
   Float_t         Electron_sip3d[nElectronMax];   //[nElectron]
   Float_t         Electron_mvaTTH[nElectronMax];   //[nElectron]
   Int_t           Electron_charge[nElectronMax];   //[nElectron]
   Int_t           Electron_cutBased[nElectronMax];   //[nElectron]
   Int_t           Electron_cutBased_Fall17_V1[nElectronMax];   //[nElectron]
   Int_t           Electron_jetIdx[nElectronMax];   //[nElectron]
   Int_t           Electron_pdgId[nElectronMax];   //[nElectron]
   Int_t           Electron_photonIdx[nElectronMax];   //[nElectron]
   Int_t           Electron_tightCharge[nElectronMax];   //[nElectron]
   Int_t           Electron_vidNestedWPBitmap[nElectronMax];   //[nElectron]
   Int_t           Electron_vidNestedWPBitmapHEEP[nElectronMax];   //[nElectron]
   Bool_t          Electron_convVeto[nElectronMax];   //[nElectron]
   Bool_t          Electron_cutBased_HEEP[nElectronMax];   //[nElectron]
   Bool_t          Electron_isPFcand[nElectronMax];   //[nElectron]
   UChar_t         Electron_jetNDauCharged[nElectronMax];   //[nElectron]
   UChar_t         Electron_lostHits[nElectronMax];   //[nElectron]
   Bool_t          Electron_mvaFall17V1Iso_WP80[nElectronMax];   //[nElectron]
   Bool_t          Electron_mvaFall17V1Iso_WP90[nElectronMax];   //[nElectron]
   Bool_t          Electron_mvaFall17V1Iso_WPL[nElectronMax];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WP80[nElectronMax];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WP90[nElectronMax];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WPL[nElectronMax];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WP80[nElectronMax];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WP90[nElectronMax];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WPL[nElectronMax];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WP80[nElectronMax];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WP90[nElectronMax];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WPL[nElectronMax];   //[nElectron]
   UChar_t         Electron_seedGain[nElectronMax];   //[nElectron]
   UInt_t          nFatJet;
   Float_t         FatJet_area[nJetMax];   //[nFatJet]
   Float_t         FatJet_btagCMVA[nJetMax];   //[nFatJet]
   Float_t         FatJet_btagCSVV2[nJetMax];   //[nFatJet]
   Float_t         FatJet_btagDDBvL[nJetMax];   //[nFatJet]
   Float_t         FatJet_btagDDBvLV2[nJetMax];   //[nFatJet]
   Float_t         FatJet_btagDDBvL_noMD[nJetMax];   //[nFatJet]
   Float_t         FatJet_btagDDCvB[nJetMax];   //[nFatJet]
   Float_t         FatJet_btagDDCvBV2[nJetMax];   //[nFatJet]
   Float_t         FatJet_btagDDCvB_noMD[nJetMax];   //[nFatJet]
   Float_t         FatJet_btagDDCvL[nJetMax];   //[nFatJet]
   Float_t         FatJet_btagDDCvLV2[nJetMax];   //[nFatJet]
   Float_t         FatJet_btagDDCvL_noMD[nJetMax];   //[nFatJet]
   ...
   Float_t         FatJet_nnJetMaxb1[nJetMax];   //[nFatJet]
   Float_t         FatJet_particleNetMD_QCD[nJetMax];   //[nFatJet]
   Float_t         FatJet_particleNetMD_Xbb[nJetMax];   //[nFatJet]
   Float_t         FatJet_particleNetMD_Xcc[nJetMax];   //[nFatJet]
   Float_t         FatJet_particleNetMD_Xqq[nJetMax];   //[nFatJet]
   Float_t         FatJet_particleNet_H4qvsQCD[nJetMax];   //[nFatJet]
   Float_t         FatJet_particleNet_HbbvsQCD[nJetMax];   //[nFatJet]
   Float_t         FatJet_particleNet_HccvsQCD[nJetMax];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD[nJetMax];   //[nFatJet]
   Float_t         FatJet_particleNet_TvsQCD[nJetMax];   //[nFatJet]
   Float_t         FatJet_particleNet_WvsQCD[nJetMax];   //[nFatJet]
   Float_t         FatJet_particleNet_ZvsQCD[nJetMax];   //[nFatJet]
   ...
   Float_t         FatJet_lsf3[nJetMax];   //[nFatJet]
   Int_t           FatJet_jetId[nJetMax];   //[nFatJet]
   Int_t           FatJet_subJetIdx1[nJetMax];   //[nFatJet]
   Int_t           FatJet_subJetIdx2[nJetMax];   //[nFatJet]
   Int_t           FatJet_electronIdx3SJ[nJetMax];   //[nFatJet]
   Int_t           FatJet_muonIdx3SJ[nJetMax];   //[nFatJet]
   UInt_t          nFsrPhoton;
   Float_t         FsrPhoton_dROverEt2[nPhotonMax];   //[nFsrPhoton]
   Float_t         FsrPhoton_eta[nPhotonMax];   //[nFsrPhoton]
   Float_t         FsrPhoton_phi[nPhotonMax];   //[nFsrPhoton]
   Float_t         FsrPhoton_pt[nPhotonMax];   //[nFsrPhoton]
   Float_t         FsrPhoton_relIso03[nPhotonMax];   //[nFsrPhoton]
   Int_t           FsrPhoton_muonIdx[nPhotonMax];   //[nFsrPhoton]
   UInt_t          nGenJetAK8;
   Float_t         GenJetAK8_eta[nGenJetMax];   //[nGenJetAK8]
   Float_t         GenJetAK8_mass[nGenJetMax];   //[nGenJetAK8]
   Float_t         GenJetAK8_phi[nGenJetMax];   //[nGenJetAK8]
   Float_t         GenJetAK8_pt[nGenJetMax];   //[nGenJetAK8]
   UInt_t          nGenJet;
   ...
   Float_t         SubGenJetAK8_eta[nGenJetMax];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_mass[nGenJetMax];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_phi[nGenJetMax];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_pt[nGenJetMax];   //[nSubGenJetAK8]
   ...
   Float_t         GenVtx_z;
   UInt_t          nGenVisTau;
   Float_t         GenVisTau_eta[nTauMax];   //[nGenVisTau]
   Float_t         GenVisTau_mass[nTauMax];   //[nGenVisTau]
   Float_t         GenVisTau_phi[nTauMax];   //[nGenVisTau]
   Float_t         GenVisTau_pt[nTauMax];   //[nGenVisTau]
   Int_t           GenVisTau_charge[nTauMax];   //[nGenVisTau]
   Int_t           GenVisTau_genPartIdxMother[nTauMax];   //[nGenVisTau]
   Int_t           GenVisTau_status[nTauMax];   //[nGenVisTau]
   Float_t         genWeight;
   ...
   UInt_t          nIsoTrack;
   Float_t         IsoTrack_dxy[nIsoTrackMax];   //[nIsoTrack]
   Float_t         IsoTrack_dz[nIsoTrackMax];   //[nIsoTrack]
   Float_t         IsoTrack_eta[nIsoTrackMax];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_all[nIsoTrackMax];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_chg[nIsoTrackMax];   //[nIsoTrack]
   Float_t         IsoTrack_phi[nIsoTrackMax];   //[nIsoTrack]
   Float_t         IsoTrack_pt[nIsoTrackMax];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_all[nIsoTrackMax];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_chg[nIsoTrackMax];   //[nIsoTrack]
   Int_t           IsoTrack_fromPV[nIsoTrackMax];   //[nIsoTrack]
   Int_t           IsoTrack_pdgId[nIsoTrackMax];   //[nIsoTrack]
   Bool_t          IsoTrack_isHighPurityTrack[nIsoTrackMax];   //[nIsoTrack]
   Bool_t          IsoTrack_isPFcand[nIsoTrackMax];   //[nIsoTrack]
   Bool_t          IsoTrack_isFromLostTrack[nIsoTrackMax];   //[nIsoTrack]
   UInt_t          nJet;
   ...
   Float_t         Jet_cRegCorr[nJetMax];   //[nJet]
   Float_t         Jet_cRegRes[nJetMax];   //[nJet]
   ...
   UChar_t         LHE_NpLO;
   UInt_t          nLHEPart;
   Float_t         LHEPart_pt[nLHEPartMax];   //[nLHEPart]
   Float_t         LHEPart_eta[nLHEPartMax];   //[nLHEPart]
   Float_t         LHEPart_phi[nLHEPartMax];   //[nLHEPart]
   Float_t         LHEPart_mass[nLHEPartMax];   //[nLHEPart]
   Float_t         LHEPart_incomingpz[nLHEPartMax];   //[nLHEPart]
   Int_t           LHEPart_pdgId[nLHEPartMax];   //[nLHEPart]
   Int_t           LHEPart_status[nLHEPartMax];   //[nLHEPart]
   Int_t           LHEPart_spin[nLHEPartMax];   //[nLHEPart]
   Float_t         GenMET_phi;
   Float_t         GenMET_pt;
   ...
   Float_t         Muon_mvaTTH[nMuonMax];   //[nMuon]
   Int_t           Muon_charge[nMuonMax];   //[nMuon]
   Int_t           Muon_jetIdx[nMuonMax];   //[nMuon]
   Int_t           Muon_nStations[nMuonMax];   //[nMuon]
   Int_t           Muon_nTrackerLayers[nMuonMax];   //[nMuon]
   Int_t           Muon_pdgId[nMuonMax];   //[nMuon]
   Int_t           Muon_tightCharge[nMuonMax];   //[nMuon]
   Int_t           Muon_fsrPhotonIdx[nMuonMax];   //[nMuon]
   ...
   UChar_t         Muon_mvaId[nMuonMax];   //[nMuon]
   UChar_t         Muon_mvaLowPtId[nMuonMax];   //[nMuon]
   ...
   UInt_t          nPhoton;
   Float_t         Photon_eCorr[nPhotonMax];   //[nPhoton]
   ...
   Bool_t          Photon_isScEtaEE[nPhotonMax];   //[nPhoton]
   Bool_t          Photon_mvaID_WP80[nPhotonMax];   //[nPhoton]
   Bool_t          Photon_mvaID_WP90[nPhotonMax];   //[nPhoton]
   Bool_t          Photon_pixelSeed[nPhotonMax];   //[nPhoton]
   UChar_t         Photon_seedGain[nPhotonMax];   //[nPhoton]
   ...
   Float_t         GenDressedLepton_eta[nElectronMax];   //[nGenDressedLepton]
   Float_t         GenDressedLepton_mass[nElectronMax];   //[nGenDressedLepton]
   Float_t         GenDressedLepton_phi[nElectronMax];   //[nGenDressedLepton]
   Float_t         GenDressedLepton_pt[nElectronMax];   //[nGenDressedLepton]
   Int_t           GenDressedLepton_pdgId[nElectronMax];   //[nGenDressedLepton]
   Bool_t          GenDressedLepton_hasTauAnc[nElectronMax];   //[nGenDressedLepton]
   UInt_t          nGenIsolatedPhoton;
   Float_t         GenIsolatedPhoton_eta[nPhotonMax];   //[nGenIsolatedPhoton]
   Float_t         GenIsolatedPhoton_mass[nPhotonMax];   //[nGenIsolatedPhoton]
   Float_t         GenIsolatedPhoton_phi[nPhotonMax];   //[nGenIsolatedPhoton]
   Float_t         GenIsolatedPhoton_pt[nPhotonMax];   //[nGenIsolatedPhoton]
   ...
   UInt_t          nTau;
   Float_t         Tau_chargedIso[nTauMax];   //[nTau]
   Float_t         Tau_dxy[nTauMax];   //[nTau]
   Float_t         Tau_dz[nTauMax];   //[nTau]
   Float_t         Tau_eta[nTauMax];   //[nTau]
   Float_t         Tau_leadTkDeltaEta[nTauMax];   //[nTau]
   Float_t         Tau_leadTkDeltaPhi[nTauMax];   //[nTau]
   Float_t         Tau_leadTkPtOverTauPt[nTauMax];   //[nTau]
   Float_t         Tau_mass[nTauMax];   //[nTau]
   Float_t         Tau_neutralIso[nTauMax];   //[nTau]
   Float_t         Tau_phi[nTauMax];   //[nTau]
   Float_t         Tau_photonsOutsideSignalCone[nTauMax];   //[nTau]
   Float_t         Tau_pt[nTauMax];   //[nTau]
   Float_t         Tau_puCorr[nTauMax];   //[nTau]
   Float_t         Tau_rawAntiEle[nTauMax];   //[nTau]
   Float_t         Tau_rawAntiEle2018[nTauMax];   //[nTau]
   Float_t         Tau_rawDeepTau2017v2p1VSe[nTauMax];   //[nTau]
   Float_t         Tau_rawDeepTau2017v2p1VSjet[nTauMax];   //[nTau]
   Float_t         Tau_rawDeepTau2017v2p1VSmu[nTauMax];   //[nTau]
   Float_t         Tau_rawIso[nTauMax];   //[nTau]
   Float_t         Tau_rawIsodR03[nTauMax];   //[nTau]
   Float_t         Tau_rawMVAnewDM2017v2[nTauMax];   //[nTau]
   Float_t         Tau_rawMVAoldDM[nTauMax];   //[nTau]
   Float_t         Tau_rawMVAoldDM2017v1[nTauMax];   //[nTau]
   Float_t         Tau_rawMVAoldDM2017v2[nTauMax];   //[nTau]
   Float_t         Tau_rawMVAoldDMdR032017v2[nTauMax];   //[nTau]
   Int_t           Tau_charge[nTauMax];   //[nTau]
   Int_t           Tau_decayMode[nTauMax];   //[nTau]
   Int_t           Tau_jetIdx[nTauMax];   //[nTau]
   Int_t           Tau_rawAntiEleCat[nTauMax];   //[nTau]
   Int_t           Tau_rawAntiEleCat2018[nTauMax];   //[nTau]
   UChar_t         Tau_idAntiEle[nTauMax];   //[nTau]
   UChar_t         Tau_idAntiEle2018[nTauMax];   //[nTau]
   Bool_t          Tau_idAntiEleDeadECal[nTauMax];   //[nTau]
   UChar_t         Tau_idAntiMu[nTauMax];   //[nTau]
   Bool_t          Tau_idDecayMode[nTauMax];   //[nTau]
   Bool_t          Tau_idDecayModeNewDMs[nTauMax];   //[nTau]
   UChar_t         Tau_idDeepTau2017v2p1VSe[nTauMax];   //[nTau]
   UChar_t         Tau_idDeepTau2017v2p1VSjet[nTauMax];   //[nTau]
   UChar_t         Tau_idDeepTau2017v2p1VSmu[nTauMax];   //[nTau]
   UChar_t         Tau_idMVAnewDM2017v2[nTauMax];   //[nTau]
   UChar_t         Tau_idMVAoldDM[nTauMax];   //[nTau]
   UChar_t         Tau_idMVAoldDM2017v1[nTauMax];   //[nTau]
   UChar_t         Tau_idMVAoldDM2017v2[nTauMax];   //[nTau]
   UChar_t         Tau_idMVAoldDMdR032017v2[nTauMax];   //[nTau]
   Float_t         TkMET_phi;
   Float_t         TkMET_pt;
   Float_t         TkMET_sumEt;
   UInt_t          nTrigObj;
   ...
   Float_t         SV_dxy[nSVMax];   //[nSV]
   Float_t         SV_dxySig[nSVMax];   //[nSV]
   Float_t         SV_pAngle[nSVMax];   //[nSV]
   Int_t           Electron_genPartIdx[nElectronMax];   //[nElectron]
   UChar_t         Electron_genPartFlav[nElectronMax];   //[nElectron]
   ...
   Int_t           Photon_genPartIdx[nPhotonMax];   //[nPhoton]
   UChar_t         Photon_genPartFlav[nPhotonMax];   //[nPhoton]
   Float_t         MET_fiducialGenPhi;
   Float_t         MET_fiducialGenPt;
   UChar_t         Electron_cleanmask[nElectronMax];   //[nElectron]
   UChar_t         Jet_cleanmask[nJetMax];   //[nJet]
   UChar_t         Muon_cleanmask[nMuonMax];   //[nMuon]
   UChar_t         Photon_cleanmask[nPhotonMax];   //[nPhoton]
   UChar_t         Tau_cleanmask[nTauMax];   //[nTau]
   Int_t           SubJet_hadronFlavour[nJetMax];   //[nSubJet]
   UChar_t         SubJet_nBHadrons[nJetMax];   //[nSubJet]
   UChar_t         SubJet_nCHadrons[nJetMax];   //[nSubJet]
   ...
   UChar_t         SV_ntracks[nSVMax];   //[nSV]
   Int_t           Tau_genPartIdx[nTauMax];   //[nTau]
   UChar_t         Tau_genPartFlav[nTauMax];   //[nTau]
   ...
   GamHistosFill(TTree *tree=0, int itype=1, string datasetname="2018P8");
...
: fChain(0), isMC(itype), dataset(datasetname)
{
  ...
  cout << "Creating GamHistosFill for " << dataset << " "
       << (isMC ? "MC" : "Data") <<endl<<flush;

// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
     //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("files/mc-ht-200to400.root");
     //if (!f || !f->IsOpen()) {
      //  f = new TFile("files/mc-ht-200to400.root");
      //}
